        ...
        <div className="flex flex-col items-center justify-center font-semibold px-3 gap-3 border-2 border-primary">
          <div className="flex flex-col md:flex-row gap-6 items-center w-3/4 pt-3">
            ...
            <p className="text-sm md:text-base bg-primary text-white p-5 rounded">
              ...
              natural ingredients that leave your hair and skin feeling fresh
              and rejuvenated.
            </p>
          </div>
          <div className="flex flex-col md:flex-row gap-6 items-center w-3/4">
            ...
            <p className="text-sm md:text-base bg-primary text-white p-5 rounded">
              ...
              beard, while moisturizing the skin underneath. It helps to
              eliminate itchiness and beardruff, promoting healthier beard
              growth.
            </p>
          </div>
          <div className="flex flex-col md:flex-row gap-6 items-center w-3/4">
            ...
            <p className="text-sm md:text-base bg-primary text-white p-5 rounded">
              Our hair clay and pomade provide a strong hold with a matte
              finish. They are perfect for achieving a variety of hairstyles
              while maintaining the hair's flexibility. Enriched with natural
